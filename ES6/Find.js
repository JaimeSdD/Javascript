...
// const find1 = numbers.find(function (number){return number === 100});
...
const findMovie = movies.filter(movie => movie.date === 2010);
...
const fusion = {...alienFinder, mutation : {...mutationFinder}};
console.log(fusion);