...
console.log(`Tu segundo poder es ${elBoss.poderes[1].nombre} que ${elBoss.poderes[1].description}`)
...
console.log(`Conozco a tu ${elBoss.familiares[2].parentesco}, ${elBoss.familiares[2].nombre} de ${elBoss.familiares[2].edad} años.`)
